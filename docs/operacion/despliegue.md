...
| `SUPPORT_EMAIL` | `contacto@sendik.co` | ídem |
...
| `LEGAL_TERMS_VERSION`, `LEGAL_PRIVACY_VERSION` | `2026-09-16` desde el 16 de septiembre de 2026 | `borrador-local` todavía: publicar en `prod` es otra decisión |
