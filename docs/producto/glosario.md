...
| Remitente | `Sender` | Quien figura como tal en la guía: el titular de la cuenta, con el nombre y el teléfono de su perfil (RN-078, RN-106). No es un dato que se escriba en el origen: se lee del perfil. |
