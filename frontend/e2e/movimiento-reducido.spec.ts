 ...
 * sin una prueba que lo mirara: la regla vivia en `tokens.css` y se daba por
 * hecha. Al retirar esa hoja (ADR-0032) la regla global desaparecio y solo quedo
 * detenido el brillo del esqueleto; las transiciones de los botones y lo que
 * trae `tw-animate-css` siguieron corriendo. **No lo vio nadie**, porque axe no
 * evalua movimiento y ninguna prueba abria el sitio con la preferencia puesta.
 *
 ...
 * pantalla siga teniendo ese boton, y de que ese boton siga estando en el estado
 * que la hace visible.
 */
